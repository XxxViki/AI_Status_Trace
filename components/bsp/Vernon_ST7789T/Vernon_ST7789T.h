...
typedef struct {
    ...
    /* IDF 6.x 适配：旧类型 lcd_color_rgb_endian_t 已改名为 lcd_rgb_element_order_t */
    ...
    void *vendor_config; /*!< vendor specific configuration, optional, left as NULL if it's not used */
